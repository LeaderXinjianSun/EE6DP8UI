...
'// Data Access
Declare Function ModbusDat Lib "DMT.dll" (ByVal comm_type As Long, ByVal conn_num As Long, ByVal slave_addr As Long, ByVal func_code As Long, ByRef sendbuf As Byte, ByVal sendlen As Long, ByRef recv_slave_addr As Long, ByRef recv_func_code As Long, ByRef recvbuf As Byte, ByVal retry As Long, ByVal timeout As Long) As Long
...
Declare Function OpenModbusTCPSocket Lib "DMT.dll" (ByVal conn_num As Long, ByVal ipaddr As Long, ByVal port As Long) As Long
