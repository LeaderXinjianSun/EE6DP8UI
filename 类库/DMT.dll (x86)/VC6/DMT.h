...
//		05/05/2014		Anderson		Taoyuan III		Version 2.3
...
//Modbus Data
int WINAPI ModbusData(int comm_type, int conn_num, int slave_addr, int func_code, unsigned char *sendbuf, int sendlen, int *station_ret, int *func_ret, unsigned char *recvbuf, int retry, int timeout);
...
int WINAPI OpenModbusSerialEx(int conn_num, int baud_rate, int format, int modbus_mode);
